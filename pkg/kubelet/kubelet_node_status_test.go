...
func TestReconcileExtendedResource(t *testing.T) {
	...
	//testKubeletNoCheckpoint.kubelet.containerManager = c
	//testKubeletNoCheckpoint.kubelet.kubeClient = nil       // ensure only the heartbeat client is used
	//testKubeletNoCheckpoint.kubelet.containerManager = nil // ensure that no checkpoint is written
	...
	cases := []struct {
		...
		{
			// need to get testkubelet.containermanager.devicemanager.checkpointmanager
			name:        "extended resource capacity is not zeroed due to presense of checkpoint file",
			testKubelet: testKubelet,
			existingNode: &v1.Node{
				Status: v1.NodeStatus{
					Capacity: v1.ResourceList{
